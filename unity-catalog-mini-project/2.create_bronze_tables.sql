...
-- MAGIC Bronze folder path  'abfss://bronze@formula1ucdlext.dfs.core.windows.net/'
...
USING json
OPTIONS (path "abfss://bronze@formula1ucdlext.dfs.core.windows.net/drivers.json");
...
USING JSON
OPTIONS(path "abfss://bronze@formula1ucdlext.dfs.core.windows.net/results.json")
